...
Provides admin user management and administration APIs.
"""
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("admin_management_service_starting", version=app_settings.app_version)
    logger.info("admin_management_service_started", version=app_settings.app_version)
    
    yield
    
    # Shutdown
    logger.info("admin_management_service_shutting_down")
    logger.info("admin_management_service_shutdown")


# Create FastAPI app
app = FastAPI(
    title="CloudSound Admin Management Service",
    version=app_settings.app_version,
    description="Admin user management and administration APIs",
    docs_url="/docs",
    redoc_url="/redoc",
